export const AllProject = [
  ...
  {
    name1: "amazon-clone",
    gihub1: "https://github.com/Mrunal-Malkar/Amazon-clone-using-Html-CSS",
    ...
    gihub2: "https://github.com/Mrunal-Malkar/Bookstore-website-MERN-stack",
    image2: "BookStore.png",
    livelink2: "https://bookstore-website-mern-stack.vercel.app/",
  },
  {
    name1: "Contact-app",
    gihub1: "https://github.com/Mrunal-Malkar/Contact-app-using-firebase-and-react",
    ...
    gihub2: "https://github.com/Mrunal-Malkar/Font-awesome-website-clone-using-bootstrap-CSS",
    image2: "fontawesomeclone.jpg",
    livelink2: "",
  },
  {
    name1: "Rock-paper-scissors",
    gihub1: "https://github.com/Mrunal-Malkar/Rock-Paper-Scissor-game-using-Javascript-js-",
    ...
    gihub2: "https://github.com/Mrunal-Malkar/To-Do-List-with-React",
    image2: "todolist.jpg",
    livelink2: "",
  },
];
...
function getTopProjects() {
  ...
  const topProject = AllProject.map((val) => {
    ...
    if (
      ...
      no.push("1");
      if(no.length>=3){
       return { name1: val.name1, about1: val.about1, gihub1: val.gihub1, image1: val.image1, livelink1: val.livelink1 }
      }else{
        return val;
      }
