...
const WhyGoOnline = () => {
  return (
    <div className="w-full bg-gray-50 p-16 flex flex-col items-center">
      <div className="sm:w-4/6 flex flex-col w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
          ...
          {/* Card 1 */}
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="text-5xl p-4 bg-blue-100 text-blue-700 rounded-full shadow-sm">
              <FaArrowTrendUp />
            </div>
            <h1 className="font-semibold text-xl">Grow Customers</h1>
          ...
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h1 className="font-semibold text-xl">Earn Even When Closed</h1>
            <p className="text-center text-base">
          ...
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h1 className="font-semibold text-xl">Reach Mobile-First Buyers</h1>
            <p className="text-center text-base">
          ...
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h1 className="font-semibold text-xl">Showcase Your Products</h1>
            <p className="text-center text-base">
          ...
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h1 className="font-semibold text-xl">Smarter Selling</h1>
            <p className="text-center text-base">
          ...
          <div className="flex flex-col items-center w-full text-gray-800 p-8 gap-y-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h1 className="font-semibold text-xl">Build Trust & Credibility</h1>
            <p className="text-center text-base">
