...
const Services = () => (
  <>
    ...
    {/* what i offer */}
    <div className="w-full bg-white p-4 sm:p-16 flex flex-col items-center">
      {/* <div className="w-[480px] "> */}
      <div className="w-content ">
      <PlanTabs />  {/* -- For mobile resolution */}
      </div>
      {/* <div className="w-full md:hidden md:w-4/6 flex flex-col justify-center gap-y-6">
        <h1 className="w-full text-center text-2xl text-black font-semibold">
          Plan:
        </h1>
      <PlanTabs />  {/* -- For pc resolution */}
      {/* </div> */}
    </div>
  </>
);
