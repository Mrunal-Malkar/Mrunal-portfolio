        ...
        <div className="h-[40%] flex flex-col w-full p-3 justify-around items-start">
          ...
          >
            ...
            <a
              ...
              className={`min-w-6 min-h-6 ${
                val.livelink ? "flex" : "hidden"
              } hover:text-blue-500 items-center justify-center rounded`}
            >
          ...
          <div className="flex justify-between w-full text-lg font-extralight text-gray-200">
            <div className="flex justify-between w-full items-center">
              <p className="text-lg font-light text-gray-200 tracking-wide overflow-auto">
                {val.about}
              </p>
              <a
                href={val.github}
